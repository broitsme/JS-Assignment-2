...
function minus() {var val = arguments[0]; return function(val1) { return val1 - val; }}
function plus() {var val = arguments[0]; return function(val1) { return val1 + val; }}
function times() {var val = arguments[0]; return function(val1) { return val1 * val; }}
function dividedBy() {var val = arguments[0]; return function(val1) { return parseInt(val1 / val); }}